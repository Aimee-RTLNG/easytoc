...
function updatecontent() {
  ...
  blueprint_content = blueprint_content.replace(/<\/easytoc>/g, "");
  blueprint_content = blueprint_content.replace(/ contenteditable="(.*?)\"/g, ""); // on remplace les doubles sauts de lignes

  blueprint_content = blueprint_content.replace(/\n\s*\n/g, "\n"); // on update le code par rapport au blueprint

  $('#raw-code').html(blueprint_content);
  var code_content = $('<div>').text($('#raw-code').val()).html(); // prettify
...
$('.add-element').on('click', function () {
  ...
  var previous_content = $('#content-created-blueprint form').html(); // en fonction du type , différentes actions 
