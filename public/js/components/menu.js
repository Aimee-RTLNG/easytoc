...
/*!*****************************************!*\
  !*** ./resources/js/components/menu.js ***!
  \*****************************************/
/*! exports provided: element_types, getOldContent, addMenu, refreshMoveButtons */
...
function getOldContent() {
  ...
  $('#full-menu #menu-title, #full-menu, #full-menu, #full-menu ul, #full-menu ul li, #full-menu li, #full-menu ul a, #full-menu ul li a').attr('contenteditable', true); // On récupère les paramètres
  // Theme
  ...
  var actual_title = $("#menu-title").text();
  $("#menu-creator-title").val(actual_title); // Methode

  var actual_method = $("#generated-menu").attr('method');
  $("#menu-creator-method").val(actual_method); // Lien

  var actual_link = $("#generated-menu").attr('action');
  $("#menu-creator-link").val(actual_link); // Option de réinitialisation
...
function addMenu() {
  var ul = element_types["type-menu"]["insert-menu"];
  var li = element_types["type-menu"]["insert-sous-menu"];
  menu_html = "\n\t\t\t\t" + menu_html + "\n\t\t\t";
  menu_header_html = "\n\t\t\t\t" + menu_header_html + "\n\t\t\t"; // on récupère l'ancien contenu 

  var previous_content = $('#content-created-blueprint #full-menu').html(); // en fonction du type , différentes actions 
