...
export function getOldContent() {
    ...
    $('#full-table #form-title, #full-table h2,#full-table p,#full-table a,#full-table ol,#full-table ul,#full-table hr').attr('contenteditable', true);
    ...
    // Titre
    let actual_title = $("#full-table #form-title").text();
...
export function addElement(element_type, element_type_name) {
    ...
    let previous_content = $('#content-created-blueprint #full-table').html();
