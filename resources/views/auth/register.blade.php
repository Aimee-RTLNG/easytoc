            ...
            <form class="register__form" method="POST" action="{{ route('register') }}">
                   ...
                   <div>
                        <div class="connect-network">
                            {{-- <a href="{{ route('provider_login','facebook') }}" title="{{ __('S\'inscrire via Facebook') }}"><img src="./images/facebook_logo.png" class="connect-network__img" alt="">{{ __('S\'inscrire avec') }} Facebook</a> --}}
                            <a href="{{ route('provider_login','google') }}" title="{{ __('S\'inscrire via Facebook') }}"><img src="./images/google_logo.png" class="connect-network__img" alt="">{{ __('S\'inscrire avec') }} Google</a>
                        </div>
