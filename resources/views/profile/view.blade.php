        ...
        <div class="row profile_content">
            <div class="col-md-8">
                <div class="row profile_content__filters">
                    <div class="profile_content__options">
                        <div class="profile_content__list-crea nav-item dropdown select-home btn-form-final btn-primary"  title="Menu création d'éléments HTML">
                            <a class="nav-link dropdown-toggle profile_content__list-crea__link select-home__link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Commencer un projet</a>
                    ...
                    <div class="profile_content__sort">
                        ...
                        <div class="panel-body">
                            <form id="formInfos" class="form-horizontal" method="POST" action="{{ route('profile.updateInfo', ['user' => $user]) }}">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        <div class="col">
                                            <button type="submit" form="formInfos" class="btn btn-primary btn-form-final">
                            ...
                            <form id="formPassword" class="form-horizontal" method="POST" action="{{ route('profile.updatePass', ['user' => $user]) }}">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        <div class="col">
                                            <button type="submit" form="formPassword" class="btn btn-primary btn-form-final">
                                                {{ __('Sauvegarder') }}
                                            </button>
                                        </div>
                                    </div>
