...
<div class="container wysiwyg">
    ...
    <p>Statut du propriétaire : <strong>particulier</strong><br />
        ...
        Contacter le responsable de la publication : <strong>aimeeritleng@outlook.com</strong><br />
    ...
    <p>Est désigné ci-après : <strong>Utilisateur</strong>, tout internaute se connectant et
        ...
        easytoc.ritleng.mmi-unistra.fr. Le site easytoc.ritleng.mmi-unistra.fr est mis à jour régulièrement par Aimee
        RITLENG.<br />
        Aimée RITLENG s’efforce de fournir sur le site easytoc.ritleng.mmi-unistra.fr des informations les plus précises
    ...
    service, easytoc.ritleng.mmi-unistra.fr s’engage à faire son maximum afin de rétablir l’accès au service et
    ...
    <p>
        ...
        Toute reproduction totale ou partielle du site <strong>easytoc.ritleng.mmi-unistra.fr</strong>, représentation,
        modification, publication, adaptation totale ou partielle de l'un quelconque de ces éléments, quel que soit le
        moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de <em>Aimée RITLENG</em>,
        propriétaire du site à l'email : <em>aimeeritleng@outlook.com</em>, à défaut elle sera considérée comme
    ...
    <em>Aimée RITLENG</em> n’a pas la possibilité de vérifier l'ensemble du contenu des sites ainsi visités et décline
    donc toute responsabilité de ce fait quand aux risques éventuels de contenus illicites.<br />
    L’utilisateur est informé que lors de ses visites sur le site <strong>easytoc.ritleng.mmi-unistra.fr</strong>, un ou
    des cookies sont susceptibles de s’installer automatiquement sur son ordinateur par l'intermédiaire de son logiciel
    ...
    de la manière décrite à l’adresse suivante : <a href="http://www.cnil.fr">www.cnil.fr</a>. L’utilisateur peut
    toutefois configurer le navigateur de son ordinateur pour refuser l’installation des cookies, sachant que le refus
    d'installation d'un cookie peut entraîner l’impossibilité d’accéder à certains services. Pour tout bloquage des
    ...
    <p>Sur le site <strong>easytoc.ritleng.mmi-unistra.fr</strong>, <em>Aimée RITLENG</em> ne
        ...
        <strong>easytoc.ritleng.mmi-unistra.fr.</strong> L'utilisateur fournit ces informations en toute connaissance de
        cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site
        easytoc.ritleng.mmi-unistra.fr l’obligation ou non de fournir ces informations.<br />
    ...
    <p>Aucune information personnelle de l'utilisateur du site easytoc.ritleng.mmi-unistra.fr
        ...
        autorise <em>Aimée RITLENG</em> à transmettre les dites informations à l'éventuel acquéreur qui serait à son
        tour tenu à la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site
        <strong>easytoc.ritleng.mmi-unistra.fr.</strong><br />
        Le site <strong>easytoc.ritleng.mmi-unistra.fr</strong> est en conformité avec le RGPD voir notre politique RGPD
