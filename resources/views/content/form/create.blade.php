        ...
        <div class="row creator-interfaces d-flex justify-content-around mt-5" role="section" aria-label="Actions sur l'élement">
            ...
            <div id="content-interface" class="col shadow-box border-12 bg-white p-3" role="section" aria-label="Actions sur l'élement">
                ...
                <div role="section" class="col" aria-labelledby="form_add_static">
                        ...
                        <button class="btn btn-primary btn_crea add-element type-layout" type="button" aria-label="{{ __('Nouvelle section') }}" id="insert-horizontal_rule" role="listitem" title="{{ __("Ajouter une section") }}">
                ...
                <div role="section" class="row mt-4" aria-labelledby="form_actions_element">
                    <div role="section" class="col" aria-labelledby="form_add_question">
                        ...
                        <button class="btn btn-primary btn_crea add-element type-question" type="button" aria-label="{{ __('Choix en liste') }}" id="insert-list_answer" title="{{ __('Ajouter une réponse à choix en liste') }}">
                    ...
                    <div role="section" class="col-5" aria-labelledby="form_actions_crud">
                        ...
                        <button disabled="true" aria-label="Supprimer" class="btn btn-primary btn_crea element_delete form-element-action action-delete" data-action="delete" title="{{ __('Supprimer l\'élément') }}">
                            <i class="fa fa-trash"></i>
                            {{ __('Supprimer') }}
                        </button>
                        <button disabled="true" aria-label="Annuler la suppression" class="btn btn-primary btn_crea element_undo form-element-action action-undo" data-action="undo" title="{{ __('Annuler la suppression') }}">
                    ...
                    <div class="col p-0 m-0">
                        ...
                        <div class="tab-content" id="nav-tabContent" role="section">
                            ...
                            <div class="tab-pane fade" id="nav-code" role="tabpanel" aria-labelledby="nav-code-tab">
                                ...
                                <a href="aide#formcode" class="btn btn-primary btn_crea" title="{{ __('Accéder à la fiche d\'aide') }}">
                                    <i class="fa fa-question-circle"></i>
                                    {{ __("Besoin d'aide !") }}
                                </a>
                                <div class="copy-container w-100 d-flex flex-row-reverse">
                                    <button data-clipboard-action="copy" data-clipboard-target="#css-link" id="copy-css-link" type="button" class="btn btn-info" title="{{ __('Copier le contenu') }}">
                                        {{ __("Copier") }}
                                    </button>
                                </div>
                                ...
                                <div class="copy-container w-100 d-flex flex-row-reverse">
                                    <button data-clipboard-action="copy" data-clipboard-target="#formatted-code" id="copy-raw-code" type="button" class="btn btn-info" title="{{ __('Copier le contenu') }}">
                                        {{ __("Copier") }}
                                    </button>
                                </div>
                                <!-- Code formatté -->
                ...
                <div id="actions-interface" class="border bg-white rounded p-3" style="display: none" role="section">
                    ...
                    <a href="aide#formuse" class="btn btn-primary btn_crea" title="{{ __('Accéder à la fiche d\'aide') }}">
                        <i class="fa fa-question-circle"></i>
                        {{ __("Besoin d'aide !") }}
                    </a>
                       ...
                       <!-- Si élément == select -->
                        ...
                        <!-- Ajout d'option -->
                         <div role="section" class="col action-add-option" style="display:none">
                            <button type="button" aria-label="{{ __('Ajouter une option') }}" title="{{ __('Ajouter une option') }}" data-action="add-option" class="btn btn-light form-element-action element_add-option">
                                <i class="fa fa-check-square"></i>
                                {{ __('Ajouter une option') }}
                            </button>
                        </div>
                        ...
                        <div role="section" class="col action-delete-option" style="display:none">
                           <button type="button" aria-label="{{ __('Supprimer l\'option') }}" title="{{ __('Supprimer l\'option') }}" data-action="delete-option" class="btn btn-light form-element-action element_delete-option">
